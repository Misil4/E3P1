                    ...
                    <div class="product-show-option">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 text-right">
                                <?php
$row = $products->total_products_by_brand("APIEU");
...
if ($num_total_rows > 0) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<input type="hidden" name="precio" value="'.$row['produktuKodea'].'"></input>';
    ...
    if ($total_pages > 1) {
        ...
        for ($i = 1; $i <= $total_pages; $i++) {if ($page == $i) {
            echo '<li class="page-item active"><a class="page-link" href="#">' . $page
                . '</a></li>';} else {
            echo '<li class="page-item"><a class="page-link" href="APIEU?page=' . $i
                . '">' . $i . '</a></li>';}}if ($page != $total_pages) {
            echo '<li class="page-item"><a class="page-link" href="APIEU?page=' . ($page
