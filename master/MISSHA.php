                    ...
                    <div class="product-show-option">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 text-right">
                                <?php
$row = $products->total_products_by_brand("MISSHA"); //Numero de productos
...
if ($num_total_rows > 0) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="' . $row['ruta'] . '" width=200px height=200px alt="">';
    ...
    if ($total_pages > 1) {
        if ($page != 1) {
            echo '<li class="page-item"><a class="page-link"
                                            href="MISSHA?page=' . ($page - 1) . '"><span
                                                aria-hidden="true">&laquo;</span></a></li>';
        }

        for ($i = 1; $i <= $total_pages; $i++) {if ($page == $i) {
            echo '<li class="page-item active"><a class="page-link" href="#">' . $page
                . '</a></li>';} else {
            echo '<li class="page-item"><a class="page-link" href="MISSHA?page=' . $i
                . '">' . $i . '</a></li>';}}if ($page != $total_pages) {
            echo '<li class="page-item"><a class="page-link" href="MISSHA?page=' . ($page
