                    ...
                    <div class="product-show-option">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 text-right">
                                <?php
$row = $products->total_products_by_brand("SON&PARK");
    ...
    if ($total_pages > 1) {
        if ($page != 1) {
            echo '<li class="page-item"><a class="page-link"
                                            href="SON&PARK?page=' . ($page - 1) . '"><span
        ...
        for ($i = 1; $i <= $total_pages; $i++) {if ($page == $i) {
            echo '<li class="page-item active"><a class="page-link" href="#">' . $page
                . '</a></li>';} else {
            echo '<li class="page-item"><a class="page-link" href="SON&PARK?page=' . $i
                . '">' . $i . '</a></li>';}}if ($page != $total_pages) {
            echo '<li class="page-item"><a class="page-link" href="SON&PARK?page=' . ($page
