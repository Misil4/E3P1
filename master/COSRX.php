                    ...
                    <div class="product-show-option">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 text-right">
                                <?php
$row = $products->total_products_by_brand("COSRX");
    ...
    if ($total_pages > 1) {
        ...
        for ($i = 1; $i <= $total_pages; $i++) {if ($page == $i) {
            echo '<li class="page-item active"><a class="page-link" href="#">' . $page
                . '</a></li>';} else {
            echo '<li class="page-item"><a class="page-link" href="COSRX?page=' . $i
                . '">' . $i . '</a></li>';}}if ($page != $total_pages) {
            echo '<li class="page-item"><a class="page-link" href=" COSRX?page=' . ($page
